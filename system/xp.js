  ...
  update: function () {
    ...
    for (var key in xp.startmenu.menuItems) {
      $("#_ui_programsmenu")
        .find("ul")
        .append(
          '<li class="menuitem" onclick="openApp(\'' +
            key +
            '\')"><img class="menuicon" src="' +
            xp.startmenu.appIcons[key] +
            '"/><span class="menuitemtext">' +
            xp.startmenu.menuItems[key] +
            "</span></li>"
        );
    }
  },
...
xp.profile = {
  image:
    "https://i.postimg.cc/FRGqfJsY/01d2e04f-e49d-4304-aa9e-55b9849b4cce-usericon.png",
  name: "User",
};
      ...
      temp.innerHTML =
        ...
        `" width="640" height="480">
          ...
          <div class="frame-container">
            <iframe seamless="seamless" width="100%" height="100%" id="frame" src="` +
        element.href +
        `"></iframe>
          </div>
        </window>`;
...
$(function () {
  xp.applications.add("winver", function () {
    ...
    var temp = document.createElement("div");
    temp.innerHTML =
      `<window title="About Web XP" width="418" height="400">
    <center>
    ...
    <br>
      ...
      <p> © 2023 a <span style="color:red">red</span><span style="color:lightgreen">hulk</span><span style="color:white">.in</span> product | All rights reserved <br>
      Web XP is browser based windows xp desktop clone. </p>
      <br>
      <a href="https://redhulk.in/support-os" target="_blank"><img src="https://pay.google.com/about/static_kcs/images/gifs/gpay.gif" alt="Donate" style="height: 50px !important;width: 200px !important;" ></a>
      <br><br>
      <a href="https://instagram.com/redhulk.in"><img src="https://i.postimg.cc/85VDdWSw/instagram.png"></a>
      <a href="https://github.com/r3dhulk"><img src="https://i.postimg.cc/wBNgs2S7/github.png"></a>
<br>      
      </center>
...
function openStartMenu() {
  ...
  xp.audio.playURL(
    "https://cdn.glitch.com/01d2e04f-e49d-4304-aa9e-55b9849b4cce%2FWindows%20XP%20Start.wav?1522621401979"
  );
}
...
function toggleStartMenu() {
  ...
  if (el.attr("isopen") === "true") closeStartMenu();
  else openStartMenu();
}

function handleTaskbarButton(guid) {
  var el = $("window[guid=" + guid + "]");
  if (el.attr("inactive") === "false") minimizeWindow(guid);
  else moveWindowToTop(guid);
}
    ...
    <taskbar id="_ui_taskbar" class="shadow" onmousedown="return false;" oncontextmenu="return false;">
      ...
      <div class="startmenu shadow" style="display: none">
        <div class="startmenu_top">
          <img class="startmenu_usericon" src="` +
      xp.profile.image +
      `"/>
          <div class="startmenu_username">` +
      xp.profile.name +
      `</div>
        </div>
        <div class="startmenu_middle">
          <ul class="menu startmenu_programs">
            ...
            <li class="startmenuitem large" onclick="window.open('https://redhulk.in/support-os', '_blank');">
              <img src="https://pay.google.com/about/static_kcs/images/gifs/gpay.gif"/>
              <div><div>
                <b>Support</b><br/>
                Donate On GPay
              </div></div>
            ...
            <li class="startmenuitem large" onclick="window.open('https://redhulk.in/contact/', '_blank');">
              <img src="https://i.postimg.cc/dV0KXtvy/sumalya.jpg"/>
              <div><div>
                <b>Contact Us</b><br/>
            ...
            <li class="startmenuitem large" onclick="window.open('https://redhulk.in/', '_blank');">
              <img src="https://i.postimg.cc/JnL4HCV4/logo.png"/>
              <div><div>
                <b>Go To Main Website</b><br/>
                &copy; A redhulk.in product
              </div></div>
            </li>
      ...
      `"/>
            ...
            <li class="startmenuitem"  onclick="openLocation('/Documents and Settings/' + xp.profile.name + '/My Documents')">
              <img src="` +
      xp.startmenu.icons.recentdocuments +
      `"/>
              <div><div>
      ...
      `"/>
            ...
            <li class="startmenuitem" onclick="openLocation('Control Panel')">
              <img src="` +
      xp.startmenu.icons.controlpanel +
      `"/>
              <div><div>
                <b>Control Panel</b>
              </div></div>
      ...
      `"/>
            ...
            <li class="startmenuitem" onclick="window.open('https://redhulk.in/privacy-policy')">
              <img src="` +
      xp.startmenu.icons.privacy +
      `"/>
              <div><div>
                <b>Privacy Policy</b>
              </div></div>
...
`
  ...
  windowsEl.on("mousedown", function (e) {
    ...
    var canClose = !$.contains(
      $("#_ui_taskbar").find(".startmenu")[0],
      e.target
    );
    if (canClose && !$(e.target).is("button.start")) {
      ...
      if (
        $("#_ui_programsmenu").is(e.target) ||
        $("#_ui_programsmenu").has(e.target).length
      )
        return;
      if (
        $("#_ui_programsmenu")
          .closest("ul")
          .find("li.startmenuitem")
          .is(e.target) ||
        $("#_ui_programsmenu")
          .closest("ul")
          .find("li.startmenuitem")
        ...
        $("#_ui_programsmenu").css(
          "display",
          $("#_ui_programsmenu").data("isopen") ? "none " : "inline"
        );
        $("#_ui_programsmenu").data(
          "isopen",
          !$("#_ui_programsmenu").data("isopen")
        );
      } else {
        $("#_ui_programsmenu").css("display", "none");
        $("#_ui_programsmenu").data("isopen", false);
...
function runAppDialog() {
  ...
  win.content(`<form action="#">
    ...
    <p style="position: absolute; left: 54px; top: 8px;">
      ...
      Internet resource, and Web XP will open it for you.
    </p>
